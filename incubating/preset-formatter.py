...
TAGS : Dict[str,str|List[str]] = {
    ...
    "II.92a" : "traffic_sign={id};bicycle foot=designated bicycle=designated segregated=yes",
    "II.93a" : "traffic_sign={id};bicycle foot=implicit bicycle=implicit",
    "II.92b" : "traffic_sign={id};bicycle foot=designated bicycle=designated segregated=no",
    "II.93b" : "traffic_sign={id};bicycle foot=implicit bicycle=implicit",
